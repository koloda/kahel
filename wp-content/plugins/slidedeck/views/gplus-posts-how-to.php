        ...
        <dl class="slidedeck" id="gplus-posts-how-to">
            ...
            <dd>
                ...
                <div class="section">
                    ...
                    <img src="<?php echo SLIDEDECK_URLPATH; ?>/images/gplus-how-to/step1.png" class="align-left" alt="<?php _e( "Start using the Google APIs console", $namespace ); ?>" />
                    <img src="<?php echo SLIDEDECK_URLPATH; ?>/images/gplus-how-to/step2.png" class="align-right" alt="<?php _e( "Enable API Access", $namespace ); ?>" />
                </div>
            </dd>
            <dt>Step 2</dt>
            <dd>
                <div class="section">
                    ...
                    <img src="<?php echo SLIDEDECK_URLPATH; ?>/images/gplus-how-to/step3.png" alt="<?php _e( "Agree to the Terms", $namespace ); ?>" />
                </div>
            </dd>
            <dt>Step 3</dt>
            <dd>
                <div class="section">
                    ...
                    <img src="<?php echo SLIDEDECK_URLPATH; ?>/images/gplus-how-to/step4.png" alt="<?php _e( "Copy your API Key", $namespace ); ?>" />
                </div>
            </dd>
        </dl>
