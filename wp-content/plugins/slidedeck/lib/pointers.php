...
class SlideDeckPointers {
    ...
    function pointer_lens_management() {
        ...
        $this->create( "lens-management", '#' . $SlideDeckPlugin->menu['manage'] . ' a[href$="' . SLIDEDECK_BASENAME . '/lenses"]', $content );
    }
    ...
    final function render() {
        ...
        include( SLIDEDECK_DIRNAME . '/views/elements/_pointers.php' );
    }
}
